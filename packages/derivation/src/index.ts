...
export interface RequirementFixtureStrategy { kind: "none" | "resource_crud" | "seed" | "manual" | "workflow"; operation_ids: string[]; create_operation_id?: string; read_operation_id?: string; cleanup_operation_id?: string; proven: boolean; reason?: string; }
export interface RequirementPayloadStrategy { kind: "none" | "schema" | "constraint"; schema_refs?: string[]; field_ids?: string[]; field_id?: string; rule?: string; value?: unknown; values?: unknown[]; proven: boolean; reason?: string; }

...
const ALLOWED_SCENARIOS: Record<Tier, Set<string>> = {
  ...
  full: new Set(["normal", "required_field", "invalid_input", "empty_state", "boundary", "service_error", "network_failure"])
};

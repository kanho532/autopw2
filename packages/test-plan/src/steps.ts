...
export const SUPPORTED_STEP_ACTIONS = [
  ...
  "expect_status", "expect_header", "expect_json", "expect_json_schema", "expect_relation", "expect_collection", "set_variable", "capture_text", "capture_attribute", "capture_json", "capture_count", "capture_texts"
] as const;

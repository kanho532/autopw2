...
check("m3-p0-missing-is-objective-blocker", p0Missing.skeleton.some((item) => item.blocked && item.reason === "MANDATORY_CAPABILITY_NOT_OBSERVED") && p0Missing.p0_coverage_pct === 0);

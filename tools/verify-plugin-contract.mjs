...
check("plugin-has-one-unified-skill", fs.existsSync(path.join(pluginRoot, "skills", "web-audit", "SKILL.md")) && !fs.existsSync(path.join(pluginRoot, "skills", "audit-triage")));

# Release Notes — v2.1 M8

- Added explicit Chromium/Firefox/WebKit matrix execution with viewport, locale and approved auth-scope dimensions.
- Added pre-creation matrix budget refusal, batch isolation and exact logical/instance reconciliation.
- Added M8 performance, retention, fault, restart, migration and protocol compatibility verification.
- Added release operations, security, troubleshooting, profile/policy/contract and known-limitations guides.
